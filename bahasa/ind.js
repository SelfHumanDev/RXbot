...
├♡ۜۜ͜͡✿➤ *${prefix}cup*
├♡ۜۜ͜͡✿➤ *${prefix}cup2*
├♡ۜۜ͜͡✿➤ *${prefix}freefire*
├♡ۜۜ͜͡✿➤ *${prefix}wolfmetal*
├♡ۜۜ͜͡✿➤ *${prefix}harymaker*
├♡ۜۜ͜͡✿➤ *${prefix}undermaker*
├♡ۜۜ͜͡✿➤ *${prefix}carvedwood*
├♡ۜۜ͜͡✿➤ *${prefix}sandsummer*
├♡ۜۜ͜͡✿➤ *${prefix}neon*
├♡ۜۜ͜͡✿➤ *${prefix}royalmaker*
├♡ۜۜ͜͡✿➤ *${prefix}kuemaker*
├♡ۜۜ͜͡✿➤ *${prefix}galaxywallpaper*
├♡ۜۜ͜͡✿➤ *${prefix}airmaker*
├♡ۜۜ͜͡✿➤ *${prefix}cloud*
├♡ۜۜ͜͡✿➤ *${prefix}3dmaker*
├♡ۜۜ͜͡✿➤ *${prefix}ulangtahunmaker*
├♡ۜۜ͜͡✿➤ *${prefix}silverplaybutton*
├♡ۜۜ͜͡✿➤ *${prefix}holomaker*
├♡ۜۜ͜͡✿➤ *${prefix}neonligth*
├♡ۜۜ͜͡✿➤ *${prefix}christmas*
...
├♡ۜۜ͜͡✿➤ *${prefix}groupinfo*
├♡ۜۜ͜͡✿➤ *${prefix}tutuptime*
├♡ۜۜ͜͡✿➤ *${prefix}bukatime*
